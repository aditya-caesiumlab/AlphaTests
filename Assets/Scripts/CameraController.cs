...
namespace GyroscopePrototype
{
    public class CameraController : MonoBehaviour
    {
        ...
        private void Update()
        {
            if (gyroscopeController != null && gyroscopeController.isGyroEnabled)
            {
                Vector2 gyroRotation = gyroscopeController.GyroRotation;

                // Use gyro input to rotate the camera
                ApplyCameraRotation(gyroRotation);
            }
        }

        //Gyroscope Method
        private void ApplyCameraRotation(Vector2 rotation)
        {
